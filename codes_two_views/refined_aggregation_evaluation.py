...
#             start_clip = min(refined_group)
#             end_clip = max(refined_group)
#             for selected_start in selected_starts:
#                 if selected_start > start_clip and selected_start < end_clip:
#                     start_clip = selected_start
#                     break
#             for selected_end in selected_ends:
#                 if selected_end > start_clip and selected_end < end_clip:
#                     end_clip = selected_end 
#             new_refined_group = list(range(start_clip, end_clip+1))
#             new_refined_groups.append(new_refined_group)
#         all_refined_clip_groups[key] = new_refined_groups
